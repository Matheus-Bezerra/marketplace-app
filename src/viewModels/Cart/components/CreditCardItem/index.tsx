...
export const CreditCardItem: FC<CreditCardItemParams> = ({ creditCard, isSelected, setSelectedCreditCard }) => {
  const viewModel = useCreditCardItemViewModel(creditCard)

  return <CreditCardItemView {...viewModel} isSelected={isSelected} setSelectedCreditCard={setSelectedCreditCard} />
}